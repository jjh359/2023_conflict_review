...
herpestid_data[c("Atilax_paludinosus", 
                 ...
                 "Herpestes_fuscus",
                 "Herpestes_urva")] <- 1
# Note: Herpestes javanicus is Urva javanica in updated taxonomy.  H. brachyura, edwardsi, fuscus, and urva, are all
...
write.csv(multirates, file = "rates_100trees_udmodel_v2.csv")
